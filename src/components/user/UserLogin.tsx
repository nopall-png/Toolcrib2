...
export const UserLogin: React.FC = () => {
  const { session, departments, loginUserStep1, loginUserStep2 } = useAppStore();
  ...
  const handleStep2Submit = (e: React.FormEvent) => {
    ...
    if (!userName.trim() || !employeeId.trim()) {
      setStep2Error('Nama Lengkap dan ID Karyawan wajib diisi!');
      return;
    }

    loginUserStep2(userName.trim(), employeeId.trim());
  };
