...
export const MasterDataView: React.FC<MasterDataViewProps> = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Header Bar */}
      <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-xs flex items-center justify-between">
        <div>
          <div className="flex items-center space-x-4">
            <Package className="w-8 h-8 text-red-600" />
            <h2 className="text-3xl font-bold text-slate-900">Master Data Tools & Inventory</h2>
          </div>
      ...
      <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-xs flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="relative w-full md:w-96">
          <input
            ...
            className="w-full pl-14 pr-4 py-4 bg-slate-50 border border-slate-200 rounded-xl text-lg focus:outline-none focus:ring-2 focus:ring-red-500 font-medium"
          />
        ...
        <div className="flex items-center space-x-4 w-full md:w-auto justify-between md:justify-end">
          <div className="flex items-center space-x-2">
            ...
            <select
              ...
              className="px-5 py-4 bg-slate-50 border border-slate-200 rounded-xl text-base font-bold text-slate-700 focus:outline-none focus:ring-2 focus:ring-red-500 cursor-pointer"
            >
              {categories.map((cat) => (
          ...
          <div className="flex items-center space-x-1 bg-slate-100 p-2 rounded-xl">
            <button
              ...
              className={`p-3.5 rounded-lg text-base font-bold flex items-center space-x-2 transition-all ${viewMode === 'list'
            ...
            <button
              ...
              className={`p-3.5 rounded-lg text-base font-bold flex items-center space-x-2 transition-all ${viewMode === 'catalog'
                ? 'bg-white text-red-600 shadow-xs'
                : 'text-slate-500 hover:text-slate-900'
                }`}
