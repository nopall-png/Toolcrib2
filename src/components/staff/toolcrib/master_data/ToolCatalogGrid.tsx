        ...
        >
          ...
          <div className="pt-3 border-t border-slate-100">
            <div className="grid grid-cols-3 gap-2 bg-slate-50 p-2.5 rounded-xl text-center border border-slate-100">
              ...
              <div>
                <span className="text-[10px] text-indigo-500 uppercase font-bold block">Min (ROP)</span>
                <span className="text-sm font-bold text-red-600">{tool.minStock}</span>
                <span className="text-[10px] text-slate-500 block">{tool.unit}</span>
              </div>

              <div>
                <span className="text-[10px] text-indigo-500 uppercase font-bold block">Max</span>
                <span className="text-sm font-bold text-emerald-600">{tool.maxStock}</span>
                <span className="text-[10px] text-slate-500 block">{tool.unit}</span>
              </div>
            </div>
          </div>
